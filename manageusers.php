...
<body class="users">
    ...
    <table>
        ...
        <?php 
    $i = 1; // Initialize serial number counter here
    while ($row = $result->fetch_assoc()) { ?>
        <tr>
            ...
            <td>
                <?php if ($row['status'] != 1): ?>
                    <a href="approve_user.php?id=<?php echo $row['id']; ?>" class="approve">Approve</a>
                <?php endif; ?>

                <?php if ($row['status'] != 0): ?>
                    <a href="reject_user.php?id=<?php echo $row['id']; ?>" class="reject">Reject</a>
                <?php endif; ?>
            </td>
        </tr>
    <?php } ?>
